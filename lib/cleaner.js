...
async function sweep() {
  ...
  console.log('[arch-browser-cleaner] swept ' + seen.size + ' addresses, deleted ' + n + (n ? '; again in 5 minutes' : '; clean'));
}
...
// urls: adult addresses the plugin found in the browsers' databases, for the
// extension to delete by name (see listUrls in browsers.js). null keeps the
