...
// has to travel inside main.js -- otherwise main.js loads lib/index.js from a
// folder that was never installed and the plugin dies on load. esbuild bundles
// lib/ into a single expression assigned to ARCH_LIB, which is prepended to
// main.js.
//
...
const result = await build({
  ...
  external: ['obsidian', 'electron', 'path', 'fs', 'os', 'https', 'child_process', 'node:sqlite'],
  legalComments: 'none',
});
